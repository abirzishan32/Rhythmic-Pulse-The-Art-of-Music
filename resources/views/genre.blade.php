...
<body>
  ...
  <div id="container">
    ...
    <div id="wrapper">
      <div id="navigation">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="playlist-number"><a href="#content" onclick="changeContent('melodic-death')">MELODIC DEATH</a></li>
      ...
      <div id="content">
        ...
        <div id="punk-rock" class="content-section" style="display: none;">
          ...
          <p>
            ...
            The music was Hard / Garage Rock, but much <strong class="theme-color"> shorter, faster, energetic, raw and stripped </strong> to the base chords which blended in with the rapidly growing out of control Punk subculture. Many early amateur Punk Rock band names were gross and sleazy: Punk liked to indulge in a provocative culture of extreme haircuts (flashy colors, moehawks, sharp peaks), rebellious fashion (disorderly, rough, torn) and disgusting behavior, such as snorting very foul amphetamine sulphate crystals as they were the cheapest drug around. The difference with Industrial was that you could really go wild and dance to it, thus explaining its unfathomable magnetism.
            A lot of UK Punk was witnessed in the <strong class="theme-color"> Roxy club </strong> , London, whereas US Punk evolved mainly out of the legendary club <strong class="theme-color"> CBGB's </strong>, New York (which also propelled Post-Punk and New Wave).
          </p>
        </div>


        <div id="melodic-death" class="content-section" style="display: none;">
          <h3> <strong class="theme-color">MELODIC DEATH</strong> </h3>
          <h4> <strong class="theme-color"> Active : </strong> 1990 </h4>
          <p>
            Melodic death metal, often referred to as <strong class="theme-color"> "melodeath" </strong>, is a subgenre of death metal that emerged in the early 1990s,
            primarily in the <strong class="theme-color"> Nordic countries </strong>, especially Sweden and Finland.
            It blends the aggression and intensity of death metal with melodic guitar riffs and
            harmonies, creating a distinctive sound that is both brutal and melodic.
            The hallmark of melodic death metal is its <strong class="theme-color"> intricate guitar work </style>. Unlike traditional death metal, which often focuses on 
            fast, relentless riffing, melodeath features harmonized guitar lines, dual guitar solos, and melodic leads.
             These melodic elements are often inspired by classic heavy metal and even elements of folk music.
          </p>
        </div>
    ...
    <div id="extra">
      ...
      <p id="more-melodic-death" class="more-stuff-section" style="display: none;">
        <strong>Music Bands : </strong>
        <br>
        1. In Flames <br>
        2. Arch Enemy <br>
        3. Dark Tranquillity <br>
        4. Children of Bodom <br>
        5. Omnium Gatherum: <br>
        6. Black Flag <br>
      </p>
