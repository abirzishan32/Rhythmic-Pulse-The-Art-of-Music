...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link href="{{ asset('css/fonticons.css') }}" rel="stylesheet">		
...
<!-- 
    ...
    <div class="container">
            ...
            <div class="main_service_area sections text-center">
                ...
                <div class="col-sm-4">
                    <div class="single_service">
                        ...
                        <h3>ALL LESSONS ARE VIA SKYPE</h3>
                        <div class="separator"></div>
                    </div>
                </div>
            </div>
        ...
        <link href="{{ asset('js/jquery-1.11.2.min.js') }}" rel="stylesheet">
        <script src="{{ asset('js/jquery-1.11.2.min.js') }}"></script>

        <link href="{{ asset('js/jquery.easypiechart.min.js') }}" rel="stylesheet">
        <script src="{{ asset('js/jquery.easypiechart.min.js') }}"></script>

        <link href="{{ asset('js/jquery.mixitup.min.js') }}" rel="stylesheet">
        ...
        <link href="{{ asset('js/plugins.js') }}" rel="stylesheet">
        <script src="{{ asset('js/plugins.js') }}"></script>

        <link href="{{ asset('js/plugins.js') }}" rel="stylesheet">
        <script src="{{ asset('js/plugins.js') }}"></script>

        <link href="{{ asset('js/course-main.js') }}" rel="stylesheet">
